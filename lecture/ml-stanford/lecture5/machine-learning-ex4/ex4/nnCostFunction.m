...
for i = 1:m
    delta_3 = A3s(i, :)' - Y(i, :)';
    delta_2 = Theta2' * delta_3 .* sigmoidGradient([0; Z2s(i, :)']);
    Theta2_grad += delta_3 * A2s(i, :);
    Theta1_grad += delta_2(2:end) * A1s(i, :);
end
Theta1_grad /= m;
Theta2_grad /= m;
